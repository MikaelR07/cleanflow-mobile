...
export default function NotificationsFeed() {
  ...
  return (
    <div className="pb-4 bg-white dark:bg-slate-800 ">
      {/* ── FIXED TOPNAV ── */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-slate-50/95 dark:bg-slate-800/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-900 max-w-lg mx-auto pt-[calc(env(safe-area-inset-top,1rem)+1.5rem)] pb-6">
